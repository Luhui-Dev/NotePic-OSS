...
1. 打开 Obsidian 的 **Settings → Community plugins → Browse**。
2. 搜索 `NotePic OSS`，或打开 [官方插件页](https://community.obsidian.md/plugins/notepic-oss)。
3. 安装并启用 NotePic OSS。

也可以从 [NotePic-OSS-Obsidian Releases](https://github.com/Luhui-Dev/NotePic-OSS-Obsidian/releases) 下载 `main.js`、`manifest.json`、`styles.css`，放入 `<Vault>/.obsidian/plugins/notepic-oss/` 手动安装。
...
| [NotePic-OSS-Obsidian](https://github.com/Luhui-Dev/NotePic-OSS-Obsidian) | Obsidian 插件源码、插件 release、社区插件目录所需根目录文件 |
